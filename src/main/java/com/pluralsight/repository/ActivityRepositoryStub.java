...
public class ActivityRepositoryStub implements ActivityRepository {
	...
	@Override
	public List<Activity> findByDescriptionAndDurationRange(List<String> descriptions, 
															int durationFrom,
															int durationTo) {
	...
	public Activity update(Activity activity) {
		/*
		 * search the database to see if we have an activity with that ID already if
		 * resultset size == 0 insert into Activity table else update the Activity
		 */
		return activity;
	}
	...
	public void delete(String activityId) {
		// delete from activity where id = String activityId
	}
